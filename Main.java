...
public class Main {
    ...
    private static void createDummyData (SessionFactory sessionFactory) {
        try {
         ...
         //   vehicles.get(0).addSubscription(subscription);
            ...
            subscriptions.add(subscription);
            customers.get(0).addSubscription(subscription);
            //vehicles.get(1).addSubscription(subscription);
            ...
            //vehicles.get(2).addSubscription(subscription);
            ...
            vehicles.get(1).addReservation(reservation);
            ...
            vehicles.get(2).addReservation(reservation);
            ...
            reservations.add(reservation);
            parkingLots.get(0).addReservation(reservation);
            vehicles.get(0).addReservation(reservation);
            ...
            reservations.add(reservation);
            parkingLots.get(0).addReservation(reservation);
            vehicles.get(4).addReservation(reservation);
            ...
            reservations.add(reservation);
            parkingLots.get(0).addReservation(reservation);
            vehicles.get(5).addReservation(reservation);
...
//            reservations1 = new ArrayList<Reservation>(parkingLots.get(0).getReservations());
...
//                i++;
//            }
//            DailyStatistics dailyStatistics1 = new DailyStatistics(parkingLots.get(0), reservations2);
//         //   System.out.println("lates: "+dailyStatistics1.getTotalLatency());
//            System.out.println("EINAT statistics med: "+dailyStatistics1.getDailyMedianLatency());
//            System.out.println("EINAT statistics avg: "+dailyStatistics1.getDailyAverageLatency());
...
//                ArrayList<Reservation> reservations1 = Database.getCustomQuery(Database.getSessionFactory(),Reservation.class, "SELECT * FROM "+ Entities.RESERVATION.getTableName() +" WHERE DATE(arrival_time) = '"+cal+"' AND parking_lot_id='"+parkingLot.getId()+"'");
//                System.out.println("HI EINAT1");
//                if (reservations1 == null || reservations1.size()==0) return;
//                DailyStatistics dailyStatistics1 = new DailyStatistics(parkingLot, reservations1);
//                System.out.println("EINAT2"+dailyStatistics1.getTotalReservations());
//
//            }
